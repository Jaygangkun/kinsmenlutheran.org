...
class Cromatheme {
	...
	public function cromatheme_scripts() {
		...
		wp_enqueue_style('croma_font', 'https://fonts.googleapis.com/css?family=' .  rtrim($finalarray, "|"), array(), null, 'all');  

		wp_enqueue_style('tp-kaushan-css', 'https://fonts.googleapis.com/css?family=Kaushan+Script', array(), null, 'all');  

		wp_enqueue_style('tp-lato-css', 'https://fonts.googleapis.com/css?family=Lato%3A400%2C900%2C700%2C300', array(), null, 'all');  
	...
	public function cromatheme_installs() {
		...
		$plugins = array(
			...
			array(
				...
				'version' 				=> '1.3', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented. If the plugin version is higher than the plugin version installed , the user will be notified to update the plugin
			...
			array(
				...
				'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
				'version' 				=> '4.6.5', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented. If the plugin version is higher than the plugin version installed , the user will be notified to update the plugin
				'force_activation' 		=> true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
				'external_url' 			=> '', // If set, overrides default API URL and points to an external URL
			)
